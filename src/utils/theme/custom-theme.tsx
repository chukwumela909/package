...
const customTheme = createTheme({
  button: {
    base: "group relative flex items-center justify-center text-center p-0.5 font-medium rounded-md cursor-pointer",
    fullSized: "w-full",
    color: {
      default: "bg-primary text-white hover:bg-primaryemphasis",
      alternative: "bg-secondary text-white hover:bg-secondaryemphasis",
      ...
      lightprimary:
        "bg-primary/20 text-primary hover:bg-primary dark:hover:bg-primary hover:text-white",
      lightsecondary:
        "bg-secondary/20 dark:bg-darksecondary text-secondary hover:bg-secondary dark:hover:bg-secondary hover:text-white",
      lightsuccess:
        "bg-success/20 dark:bg-darksuccess text-success hover:bg-success dark:hover:bg-success hover:text-white",
      lightinfo:
        "bg-info/20 dark:bg-darkinfo text-info hover:bg-info dark:hover:bg-info hover:text-white",
      lightwarning:
      ...
      transparent:
        "bg-transparent hover:bg-primary/20 dark:hover:bg-darkprimary hover:text-primary p-0",
    },
    outlineColor: {
  ...
  badge: {
    root: {
      ...
      color: {
        ...
        lightprimary: "bg-primary/20 dark:bg-primary/20 text-primary",
        lightwarning: "bg-lightwarning dark:bg-lightwarning text-warning",
        lightinfo: "bg-info/20 dark:bg-info/20 text-info",
        lightsecondary:
          "bg-secondary/20 dark:bg-secondary/20 text-secondary",
  ...
  drawer: {
    root: {
      base: "fixed z-50 overflow-hidden bg-white dark:bg-dark p-0 transition-transform",
      backdrop: "fixed inset-0 z-30 bg-gray-900/50 dark:bg-gray-900/80",
    },
    header: {
      inner: {
        closeButton: "absolute end-2.5 top-3 flex h-8 w-8 items-center justify-center rounded-md bg-lightgray dark:bg-darkmuted text-primary",
        closeIcon: "h-4 w-4",
  ...
  table: {
    ...
    head: {
      base: "group/head text-sm font-medium capitalize text-dark dark:text-white border-b border-gray-950/20 dark:borderdarkborder",
      cell: {
  ...
  accordion: {
    root: {
      ...
      flush: {
        off: "rounded-md border-0 shadow-md dark:shadow-dark-md border-gray-950/20 dark:border-darkborder",
        on: "border-b",
      },
    },
    content: {
  ...
  tabs: {
    ...
    tablist: {
      ...
      styles: {
        default: "flex-wrap border-b border-gray-950/20 dark:border-darkborder dark:border-gray-700",
        underline: "-mb-px flex-wrap border-b border-gray-950/20 dark:border-darkborder dark:border-gray-700 ",
        ...
        variant: {
          ...
          pills: {
            ...
            active: {
              ...
              off: "rounded-md hover:bg-primary/20 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white",
            },
          },
          fullWidth: {
            base: "ml-0 flex w-full  first:ml-0 ",
            active: {
              on: " active text-primary  bg-primary/20 p-4 ",
              off: "bg-white dark:bg-dark hover:bg-primary/20 hover:text-primary dark:hover:bg-gray-800 ",
            },
          },
        },
        icon: "mr-2 h-5 w-5",
  ...
  alert: {
    ...
    color: {
      ...
      lightinfo: "bg-info/20 dark:bg-lightinfo text-info border-info",
      lightsecondary:
        "bg-secondary/20 dark:bg-lightsecondary text-secondary border-secondary",
  ...
  navbar: {
    ...
    link: {
      base: "text-base py-1.5 px-4 hover:text-secondary dark:hover:text-primary text-darklink hover:bg-primary/20 rounded-full flex justify-center items-center cursor-pointer",
      active: {
  ...
  textarea: {
    ...
    colors: {
      gray: "border border-gray-950/20 dark:border-darkborder text-dark  focus:border-primary focus:ring-0  dark:text-white dark:placeholder-gray-400 dark:focus:border-primary dark:focus:ring-0",
    },
  },
  ...
  toggleSwitch: {
    ...
    toggle: {
      ...
      checked: {
        ...
        off: "border-gray-950/20 dark:border-darkborder bg-gray-200 dark:border-gray-600 dark:bg-gray-700",
        color: {
  ...
  hr: {
    root: {
      base: "my-4 h-px border-0 bg-gray-200 dark:bg-gray-700",
    },
    text: {
  ...
  popover: {
    ...
    arrow: {
      base: "absolute h-2 w-2 z-0 rotate-45 rounded-md mix-blend-lighten bg-white border border-gray-950/20 dark:border-darkborder dark:border-gray-600 dark:bg-gray-800 dark:mix-blend-color",
  ...
  sidebar: {
    root: {
      inner:
        "bg-white dark:bg-black rounded-none w-[270px] border border-border dark:border-darkborder px-0",
    },
    item: {
    ...
    collapse: {
      button:
        "group flex gap-3 items-center rounded-md p-2.5 mb-0.5 text-[15px] cursor-pointer text-start truncate leading-[normal] font-normal text-link hover:bg-lightprimary hover:text-primary dark:text-darklink w-full dark:hover:text-primary",
      icon: {
    ...
    itemGroup: {
      base: "mt-4 space-y-0 border-t border-gray-950/20 dark:border-darkborder pt-4 first:mt-0 first:border-t-0 first:pt-0 sidebar-nav ",
    },
  },
  ...
  timeline: {
    root: {
      direction: {
        horizontal: "sm:flex",
        vertical: "relative border-l border-gray-950/20 dark:border-darkborder dark:border-gray-700",
      },
    },
    item: {
      root: {
      ...
      point: {
        ...
        marker: {
          ...
          icon: {
            ...
            wrapper:
              "absolute -left-3 flex h-6 w-6 items-center justify-center rounded-full bg-primary/20 ring-8 ring-white dark:bg-primary dark:ring-gray-900",
          },
        },
        vertical: "",
      },
  ...
  listGroup: {
    ...
    item: {
      ...
      link: {
        ...
        active: {
          off: "hover:bg-primary/20  focus:outline-none focus:ring-2 focus:ring-cyan-700 dark:border-gray-600 dark:hover:text-white dark:focus:text-white dark:focus:ring-gray-500",
          on: "bg-cyan-700 text-white dark:bg-gray-800",
        },
        disabled: {
          off: "",
          on: "cursor-not-allowed bg-primary text-white hover:bg-primary/20 hover:text-gray-900 focus:text-gray-900",
        },
        href: {
          off: "",
          on: "",
  ...
  pagination: {
    ...
    pages: {
      ...
      previous: {
        base: "ml-0 rounded-l-lg border border-gray-950/20 dark:border-darkborder  px-3 py-2 leading-tight hover:bg-primary/20 hover:text-primary dark:hover:bg-primary/20 dark:hover:text-primary",
        icon: "h-5 w-5",
      },
      next: {
        base: "rounded-r-lg border border-gray-950/20 dark:border-darkborder px-3 py-2 leading-tight hover:bg-primary/20 hover:text-primary dark:hover:bg-primary/20 dark:hover:text-primary",
        icon: "h-5 w-5",
      },
      selector: {
        base: "w-12 border border-gray-950/20 dark:border-darkborder py-2 leading-tight  hover:bg-primary/20 hover:text-primary dark:hover:bg-primary/20 dark:hover:text-primary",
        active:
          "bg-primary text-white dark:bg-primary dark:text-white hover:text-white dark:hover:text-white border border-primary",
  ...
  card: {
    root: {
      base: "flex rounded-lg border border-gray-200 bg-white shadow-md dark:border-gray-700 dark:bg-black",
