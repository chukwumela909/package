export const QuickStart = () => {
  return (
    <div className="pb-10 md:scroll-m-[180px] scroll-m-28" id="start">
      ...
      <div className="p-6 rounded-md mt-6 border border-gray-950/10 dark:border-darkborder">
      ...
      <div className="p-6 rounded-md mt-6 border border-gray-950/10 dark:border-darkborder">
        ...
        <div className="py-4 px-3 rounded-md bg-black">
          <p className="text-sm text-gray-400">
            {"> worldstreet@1.0.0 dev"}
          </p>
          <p className="text-sm text-gray-400 mt-1">{"> next dev"}</p>
          <p className="text-sm text-gray-400 mt-6">{"-Next.js 15.1.3"}</p>
