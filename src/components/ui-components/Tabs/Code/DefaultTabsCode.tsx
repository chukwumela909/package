...
const DefaultTabsCode = () => {
  ...
  <Tabs aria-label="Default tabs">
    <TabItem active title="Profile" icon={() => <Icon icon='solar:shield-user-outline' height={20} />}>
      This is{" "}
    ...
    <TabItem title="Contacts" icon={() => <Icon icon='solar:accessibility-linear' height={20} />}>
      This is{" "}
      <span className="font-medium text-gray-800 dark:text-white">
