...
import { MegaMenu, Button, NavbarCollapse, NavbarLink, NavbarToggle, MegaMenuDropdown } from "flowbite-react";
      ...
      <CardBox>
        ...
        <MegaMenu className="rounded-md">
          <div className="mx-auto flex max-w-(--breakpoint-xl) flex-wrap items-center justify-between p-4 md:space-x-8">
            ...
            <NavbarToggle />
            <NavbarCollapse>
              <NavbarLink href="#" className="text-gray-700 dark:text-gray-400 text-sm hover:!text-primary" >Home</NavbarLink>
              <NavbarLink>
                <MegaMenuDropdown toggle={<div className="text-gray-700 dark:text-gray-400 text-sm hover:!text-primary" >Company</div>}>
              ...
              <NavbarLink href="#" className="text-gray-700 dark:text-gray-400 text-sm hover:!text-primary" >Team</NavbarLink>
              <NavbarLink href="#" className="text-gray-700 dark:text-gray-400 text-sm hover:!text-primary" >Contact</NavbarLink>
            </NavbarCollapse>
          </div>
        </MegaMenu>
      </CardBox>
